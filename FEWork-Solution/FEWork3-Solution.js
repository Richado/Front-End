...
var china = function() {
    ...
    rect(x, y, w, h)
    //
    var smallLength = w / 15
    wujcxy(x + w /10, y + h / 5, w / 5)
    wujcxy(x + w / 4, y + h / 10, smallLength)
    wujcxy(x + w / 3, y + h / 5, smallLength)
    wujcxy(x + w / 3, y + h / 3, smallLength)
    wujcxy(x + w / 4, y + h / 2, smallLength)
}
